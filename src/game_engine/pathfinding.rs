...
pub fn pathfind(entity_id: usize, world: &World, entity: &Entity, entitiesref: HashMap<usize, Entity>) -> EntityDirectionOptions {
    ...
    while let Some(current) = open_set.pop() {
        ...
        for &(dx, dy) in &directions {
            ...
            if world.check_collision(true, Some(entity_id), nx, ny, 32, 32, true, Some(entitiesref.clone())) {
                continue;
            }
