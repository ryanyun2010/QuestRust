...
pub async fn run(camera: camera::Camera){
    ...
    /* ╔════════════════════════════════════════════════════════════════════════════╗
       ║               TEST SET 1 - ENSURE NOTHING HAPPENS IN BLANK WORLD           ║
       ╚════════════════════════════════════════════════════════════════════════════╝ */
    ...
    /* ╔════════════════════════════════════════════════════════════════════════════╗
       ║                 TEST SET 2 - ENSURE ENTITIES CAN KILL PLAYER               ║
       ╚════════════════════════════════════════════════════════════════════════════╝ */
    ...
    /* ╔════════════════════════════════════════════════════════════════════════════╗
       ║             TEST SET 3 - ENSURE ENTITIES ARE BLOCKED BY TERRAIN            ║
       ╚════════════════════════════════════════════════════════════════════════════╝ */
    ...
    /* ╔════════════════════════════════════════════════════════════════════════════╗
       ║          TEST SET 4 - ENSURE ENTITIES CAN PATHFIND AROUND TERRAIN          ║
       ╚════════════════════════════════════════════════════════════════════════════╝ */
    ...
    /* ╔════════════════════════════════════════════════════════════════════════════╗
       ║             TEST SET 5 - ENSURE PLAYER MOVEMENT WORKS CORRECTLY            ║
       ╚════════════════════════════════════════════════════════════════════════════╝ */
    ...
    headless.state.keys_down.insert(String::from("d"), true);
    headless.run(20).await;
    assert_colored_print("Holding both W and D moves player up and right", headless.world.player.borrow().y < player_starting_y && headless.world.player.borrow().x > player_starting_x);
    assert_colored_print("Holding both W and D moves player up and right equal amounts", player_starting_y - headless.world.player.borrow().y == headless.world.player.borrow().x - player_starting_x);
    ...
    headless.world.player.borrow_mut().x = player_starting_x;
    headless.run(20).await;
    assert_colored_print("Holding both W and A moves player up and left", headless.world.player.borrow().y < player_starting_y && headless.world.player.borrow().x < player_starting_x);
    assert_colored_print("Holding both W and A moves player up and left equal amounts", player_starting_y - headless.world.player.borrow().y == player_starting_x - headless.world.player.borrow().x);
    ...
    headless.world.player.borrow_mut().x = player_starting_x;
    headless.run(20).await;
    assert_colored_print("Holding both S and D moves player down and right", headless.world.player.borrow().y > player_starting_y && headless.world.player.borrow().x > player_starting_x);
    assert_colored_print("Holding both S and D moves player down and right equal amounts", headless.world.player.borrow().y - player_starting_y == headless.world.player.borrow().x - player_starting_x);
    ...
    headless.world.player.borrow_mut().x = player_starting_x;
    headless.run(20).await;
    assert_colored_print("Holding both S and A moves player down and left", headless.world.player.borrow().y > player_starting_y && headless.world.player.borrow().x < player_starting_x);
    assert_colored_print("Holding both S and A moves player down and left equal amounts", headless.world.player.borrow().y - player_starting_y == player_starting_x - headless.world.player.borrow().x);
    

    /* ╔════════════════════════════════════════════════════════════════════════════╗
       ║               TEST SET 6 - ENSURE PLAYER COLLIDES WITH TERRAIN             ║
       ╚════════════════════════════════════════════════════════════════════════════╝ */
    ...
    /* ╔════════════════════════════════════════════════════════════════════════════╗
       ║              TEST SET 6 - ENSURE PLAYER COLLIDES WITH ENTITIES             ║
       ╚════════════════════════════════════════════════════════════════════════════╝ */
